...
def test_motor():
    while True:
        ...
        if modulo == 'E':
            ...
            motor  = Motor(PIN_MOTOR_E_FORWARD, PIN_MOTOR_E_BACKWARD, enable=PIN_MOTOR_E_ENABLE, pwm=False)
        else:
            #enable = LED(PIN_MOTOR_W_ENABLE)
            motor  = Motor(PIN_MOTOR_W_FORWARD, PIN_MOTOR_W_BACKWARD, enable=PIN_MOTOR_W_ENABLE, pwm=False)
